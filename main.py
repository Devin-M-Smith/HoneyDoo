...
from tools.screens import MainWindow, TaskList, Register, NewTask, Refresh, NoSave, SignIn
    ...
    def load(self):
        ...
        def windowAfterLoad():
            ...
            if load == None:
                ...
                screens = [Register(), MainWindow(), TaskList(), NewTask(), Refresh(), NoSave(), SignIn()]
